...
loaded_model = load_model("D:/template_apk/models/hijaiyah.h5")
print("Model ready!!")
...
@app.route("/prediksi")
def dashboard():
    return render_template("prediksi.html", year=cur_year)


@app.route("/panduan")
def panduan():
    return render_template("panduan.html", year=cur_year)
